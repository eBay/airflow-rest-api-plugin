...
## Requirements
- Airflow Versions: 1.X
- Modules: If airflow version is v1.10.3 or lower, need install flask_jwt_extended manually

## Deploy plugin
1. Check the [plugins_folder](http://airflow.apache.org/docs/1.10.11/configurations-ref.html#plugins-folder) configuration in airflow.cfg. If not, please configure.
2. Put `rest_api_plugin.py` and `templates` folder in [plugins_floder](http://airflow.apache.org/docs/1.10.11/configurations-ref.html#plugins-folder) directory.
3. Restart the service of the airflow webserver.
